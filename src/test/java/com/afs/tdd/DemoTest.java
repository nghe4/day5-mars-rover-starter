...
class DemoTest {
    ...
    @Test
    void should_return_direction_S_when_input_command_R_direction_E() {
        String command = "R";
        String direction = "E";
        int x = 0;
        int y = 0;
    ...
    @Test
    void should_return_direction_W_when_input_command_R_direction_S() {
        String command = "R";
        String direction = "S";
        int x = 0;
        int y = 0;
    ...
    @Test
    void should_return_direction_N_when_input_command_R_direction_W() {
        String command = "R";
        String direction = "W";
        int x = 0;
        int y = 0;
    ...
    @Test
    void should_return_y_minus_when_input_command_B_direction_N() {
        String command = "B";
        String direction = "N";
        int x = 0;
        int y = 0;
    ...
    @Test
    void should_return_x_minus_when_input_command_B_direction_E() {
        String command = "B";
        String direction = "E";
        int x = 0;
        int y = 0;
    ...
    @Test
    void should_return_y_plus_when_input_command_B_direction_S() {
        String command = "B";
        String direction = "S";
        int x = 0;
        int y = 0;
    ...
    @Test
    void should_return_x_plus_when_input_command_B_direction_W() {
        String command = "B";
        String direction = "W";
        int x = 0;
        int y = 0;
